...
import 'applications/admin/bloc/kapanewon/kapanewon_cubit.dart' as _i18;
import 'applications/admin/bloc/user/user_cubit.dart' as _i16;
...
import 'applications/info_lokasi/bloc/cubit/info_lokasi_cubit.dart' as _i17;
...
import 'applications/kontak_kami/bloc/cubit/kontak_kami_cubit.dart' as _i19;
...
import 'applications/login/bloc/login/login_cubit.dart' as _i20;
import 'applications/login/bloc/register/register_cubit.dart' as _i13;
...
import 'applications/tentang_kami/bloc/cubit/tentang_kami_cubit.dart' as _i21;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i13.RegisterCubit>(
      () => _i13.RegisterCubit(get<_i11.LoginRepo>()));
  gh.factory<_i14.TentangKamirepo>(() => _i15.TentangKamiRepoImpl());
  gh.factory<_i16.UserCubit>(() => _i16.UserCubit(get<_i3.AdminUserRepo>()));
  gh.factory<_i17.InfoLokasiCubit>(
      () => _i17.InfoLokasiCubit(get<_i9.LocationRepo>()));
  gh.factory<_i18.KapanewonCubit>(
      () => _i18.KapanewonCubit(get<_i5.KapanewonRepo>()));
  gh.factory<_i19.KontakKamiCubit>(
      () => _i19.KontakKamiCubit(get<_i7.KontakKamiRepo>()));
  gh.factory<_i20.LoginCubit>(() => _i20.LoginCubit(get<_i11.LoginRepo>()));
  gh.factory<_i21.TentangKamiCubit>(
      () => _i21.TentangKamiCubit(get<_i14.TentangKamirepo>()));
  return get;
}
