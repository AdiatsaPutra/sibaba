...
import 'applications/admin/bloc/gallery/gallery_cubit.dart' as _i22;
import 'applications/admin/bloc/kapanewon/kapanewon_cubit.dart' as _i24;
import 'applications/admin/bloc/user/user_cubit.dart' as _i19;
import 'applications/admin/bloc/ustadz/ustadz_cubit.dart' as _i28;
...
import 'applications/info_lokasi/bloc/cubit/info_lokasi_cubit.dart' as _i23;
...
import 'applications/kontak_kami/bloc/cubit/kontak_kami_cubit.dart' as _i25;
...
import 'applications/login/bloc/login/login_cubit.dart' as _i26;
...
import 'applications/tentang_kami/bloc/cubit/tentang_kami_cubit.dart' as _i27;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i22.GalleryCubit>(
      () => _i22.GalleryCubit(get<_i6.GalleryRepo>()));
  gh.factory<_i23.InfoLokasiCubit>(
      () => _i23.InfoLokasiCubit(get<_i12.LocationRepo>()));
  gh.factory<_i24.KapanewonCubit>(
      () => _i24.KapanewonCubit(get<_i8.KapanewonRepo>()));
  gh.factory<_i25.KontakKamiCubit>(
      () => _i25.KontakKamiCubit(get<_i10.KontakKamiRepo>()));
  gh.factory<_i26.LoginCubit>(() => _i26.LoginCubit(get<_i14.LoginRepo>()));
  gh.factory<_i27.TentangKamiCubit>(
      () => _i27.TentangKamiCubit(get<_i17.TentangKamirepo>()));
  gh.factory<_i28.UstadzCubit>(() => _i28.UstadzCubit(get<_i20.UstadzRepo>()));
  return get;
}
