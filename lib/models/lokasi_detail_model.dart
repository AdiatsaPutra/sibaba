...
class LokasiDetailModel extends Equatable {
  const LokasiDetailModel({
    required this.foto,
    required this.maps,
  ...
  final DetailLokasi detailLokasi;
  final List<Ustadz> ustadzs;

  factory LokasiDetailModel.fromJson(String str) =>
      LokasiDetailModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory LokasiDetailModel.fromMap(Map<String, dynamic> json) =>
      LokasiDetailModel(
        ...
        detailLokasi: DetailLokasi.fromMap(json["detail-lokasi"]),
        ustadzs:
...
class DetailLokasi {
  ...
  factory DetailLokasi.fromJson(String str) =>
      DetailLokasi.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DetailLokasi.fromMap(Map<String, dynamic> json) => DetailLokasi(
...
class Ustadz {
  ...
  factory Ustadz.fromJson(String str) => Ustadz.fromMap(json.decode(str));
