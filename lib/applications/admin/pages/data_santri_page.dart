...
class DataSantriPage extends StatelessWidget {
  ...
  DataSantriPage({Key? key}) : super(key: key);
        ...
        onPressed: () {
          final res = VxDialog.showCustom(context,
              child: Dialog(
                ...
                child: VStack([
                  'Input Data Santri'.text.xl.bold.make().pOnly(bottom: 10),
                  VStack([
                    'Nama Data Santri'.text.base.bold.make(),
                    TextFormField()
                        .stylized(hint: 'Masukkan Nama Data Santri')
                        .pOnly(bottom: 10),
                    'Kode Data Santri'.text.base.bold.make(),
                    TextFormField()
                        .stylized(hint: 'Kode Pos Data Santri')
                        .pOnly(bottom: 10),
                  ]),
                  Row(
